...
use crate::actions::{
    About, CheckForUpdates, CommandPalette, FocusSearch, Hide, NavigateBack, NavigateForward,
    OpenRepository, OpenSettings, Quit, Refresh, ShortcutReference, ToggleAppearance,
};

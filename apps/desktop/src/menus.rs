...
use crate::actions::{
    CommandPalette, NavigateBack, NavigateForward, OpenRepository, Quit, Refresh,
    ShortcutReference, ToggleAppearance,
};
...
pub fn application_menus() -> Vec<Menu> {
    vec![
        Menu {
            name: "Gitronimo".into(),
            items: vec![MenuItem::action("Quit Gitronimo", Quit)],
        },
        Menu {
            name: "File".into(),

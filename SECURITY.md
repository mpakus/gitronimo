...
GitRonimo does not collect telemetry by default and does not upload crash reports. Git authentication remains with the installed Git credential helper and SSH configuration; GitRonimo does not implement a credential store in the 0.9.2 release.
